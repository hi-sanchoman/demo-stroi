                ...
                <tbody>
                    @foreach($responsibles as $key => $responsible)
                        <tr data-entry-id="{{ $responsible->id }}">
                            ...
                            <td>
                                {{ $responsible->specific_user->remember_token ?? '' }}
                            </td>
                            <td>
                                {{ $responsible->order ?? '' }}
                            </td>
                            ...
                            <td>
                                @can('responsible_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.responsibles.show', $responsible->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('responsible_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.responsibles.edit', $responsible->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
