...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-constructionApplications">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($applications as $key => $application)
                        <tr data-entry-id="{{ $application->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $application->is_urgent ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-constructionApplications:not(.ajaxTable)').DataTable({ buttons: dtButtons })
