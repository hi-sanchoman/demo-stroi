...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.applicationProduct.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.application-products.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="number" name="quantity" id="quantity" value="{{ old('quantity', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_delivered_by_us') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_delivered_by_us" id="is_delivered_by_us" value="1" {{ old('is_delivered_by_us', 0) == 1 ? 'checked' : '' }}>
