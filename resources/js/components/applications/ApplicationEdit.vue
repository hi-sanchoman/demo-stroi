<template>
    <div style="padding: 20px">
        ...
        <v-row no-gutters="">
            <v-btn
                v-if="currentUser != null && application != null"
                class="mb-5"
                @click="backToList()"
            >
        ...
        <v-row no-gutters class="mt-3 mt-sm-10 d-flex flex-column-reverse flex-sm-row">
            <v-col cols="12" md="3" class="">            
                ...
                <div v-if="currentUser != null && application != null">
                    <h4 class="mt-4">Комментарии к заявке:</h4>
            ...
            <v-col
                ...
                cols="12"
                md="9"
                class="pl-0 pl-md-5 mt-6 mt-md-0"
            >
                <div v-if="errors">
                    <div
                        v-for="(v, k) in errors"
                ...
                <v-form class="space-y-6">
                    ...
                    >
                        <v-col cols="12">
                            <strong
                                >Заявка №{{
                                    application.parent?.num ?? application.num ?? `(${application.id})`
                                }}</strong
                            ><br />
                            Дата заявки: {{ application.parent?.created_at ?? application?.created_at }}
                            <a
                                class="mb-1"
                                v-if="
                                    application != null &&
                                    ...
                                    isPTDEngineer()
                                "
                                :href="`/export/application/${application.id}`"
                                >скачать заявку</a
                            >
                        </v-col>
                    </v-row>
                    ...
                    <v-row
                        ...
                        class="mt-5"
                    >
                        <v-col v-if="application.kind == 'product'" cols="12"
                            >Добавить товар к заявке:</v-col
                        >
                        <v-col
                            v-else-if="application.kind == 'equipment'"
                            cols="12"
                            >Добавить спец. технику к заявке:
                        </v-col>
                        <v-col
                            v-else-if="application.kind == 'service'"
                            cols="12"
                            >Добавить услугу к заявке:</v-col
                        >
                    </v-row>
                    ...
                    >
                        ...
                        <template v-else-if="application.kind == 'equipment'">
                            <v-col cols="12" md="4">
                                <multiselect
                                    v-model="current.equipment"
                                    :options="equipmentOptions"
                                    placeholder="Укажите спец. технику"
                                    label="name"
                                    track-by="name"
                                ></multiselect>
                            </v-col>
                    ...
                    <v-table
                        style=""
                        v-if="
                            application != null && application.kind == 'product'
                        "
                    >
                        <thead>
                            <tr>
                                ...
                                <th v-if="application.status === 'draft'">
                                    Кол-во
                                </th>
                                <template v-else>
                                    <th>заказано</th>
                        ...
                        <tbody>
                            ...
                            >
                                <tr>
                                    <td>
                                        <v-checkbox v-if="isSupplier()" v-model="positions"
                                            color="primary" :value="item.id" hide-details>
                                        </v-checkbox>
                                        <span v-if="!isSupplier()">{{ index + 1 }}</span>
                                    </td>
                                    <td style="width: 20%">
                                        {{ item.category?.name }}
                                    </td>
                                    ...
                                    >
                                        ...
                                        <span
                                            v-if="application.status != 'draft'"
                                        >
                                            {{ products[index].quantity?.toLocaleString('ru') }}
                                        </span>
                                    </td>
                                    ...
                                    <template v-else>
                                        ...
                                        <td>
                                            {{ products[index].prepared?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{
                                                ...
                                                >
                                                        ...
                                                        <div class="flex">
                                                            ...
                                                            <router-link
                                                                v-if="
                                                                    ...
                                                                    isEditable()
                                                                "
                                                                class="mt-1 text-underline-none"
                                                                to="/companies/create"
                                                                target="_blank"
                                                            >
                                                                <v-btn
                                                    ...
                                                    <td>
                                                        ...
                                                        <span
                                                            v-if="!isEditable()"
                                                            >{{
                                                                offer.quantity?.toLocaleString('ru')
                                                            }}</span
                                                        >
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        >
                                                            <a
                                                                class="px-2 py-2 mr-2 border text-black text-decoration-none hover:bg-slate-100 cursor-pointer"
                                                                target="_blank"
                                                                :href="
                                                                    '/uploads/' +
                                                                    offer.file
                    ...
                    <v-table
                        style=""
                        v-else-if="
                            application != null && application.kind == 'service'
                        "
                    >
                        <thead>
                            <tr>
                        ...
                        required density="comfortable" type="text"></v-text-field> -->
                                    ...
                                    >
                                        <v-text-field
                                            v-model="services[index].quantity"
                                            type="number"
                                            variant="plain"
                                            density="compact"
                                            v-if="application.status == 'draft'"
                        ...
                        {{ services[index].prepared }} /
                                        ...
                                        <span
                                            v-if="application.status != 'draft'"
                                        >
                                            {{ services[index].quantity?.toLocaleString('ru') }}
                                        </span>
                                    </td>
                                    ...
                                    <template v-else>
                                        ...
                                        <td>
                                            {{ services[index].prepared?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{
                                    ...
                                    <td>
                                        ...
                                        >
                                            <v-text-field
                                                ...
                                                variant="plain"
                                                density="compact"
                                                @change="onServicePriceChanged"
                                            >
                                            </v-text-field>
                                        </tempalte>

                                        <span v-else>{{ item.price?.toLocaleString('ru') }}</span>
                                    </td>
                                    <td>
                        ...
                        <tbody>
                            ...
                            >
                                <tr>
                                    ...
                                    >
                                        <v-text-field
                                            v-model="equipments[index].quantity"
                                            type="number"
                                            variant="plain"
                                            density="compact"
                                            v-if="application.status == 'draft'"
                                        ...
                                        <span
                                            v-if="application.status != 'draft'"
                                        >
                                            {{ equipments[index].quantity?.toLocaleString('ru') }}
                                        </span>
                                    </td>
                                    ...
                                    <template v-else>
                                        ...
                                        <td>
                                            {{ equipments[index].prepared?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{
                                            ...
                                            <tbody>
                                                ...
                                                >
                                                    ...
                                                    <td>
                                                        ...
                                                        >
                                                            <a
                                                                class="px-2 py-2 mr-2 border text-sm text-black text-decoration-none hover:bg-slate-100 cursor-pointer"
                                                                target="_blank"
                                                                :href="
                                                                    '/uploads/' +
                                                                    offer.file
                    ...
                    <!-- sign by PTD -->
                    <div class="d-flex justify-space-between space-x-4">
                        <div class="d-flex">
                            <v-btn v-if="
                            ...
                            <v-btn v-if="
                                ...
                                isPTDEngineer() &&
                                application.status == 'draft'
                            " class="mt-5" @click="signApplicationFirstTime" color="green">
                                Сохранить и подписать
                            </v-btn>
                        </div>

                        <v-btn v-if="application != null && application.status == 'draft' && isPTDEngineer() && isOwner()" color="red"
                            @click="deleteApplication(application.id)" class="ml-4 mt-5">
                            Удалить заявку
                        </v-btn>
                    </div>


                    <!-- sign btn by supplier -->
                    <div
                        v-if="
                            isSupplier() &&
                            application.is_accepted == 1 &&
                            !noLeftPositions() && !signedBySupplier()
                        "
                        class="d-flex flex-row justify-space-between"
                    >                    
                        <v-btn
                            color="green"
                            @click="signBySupplier()"
                            class="mt-5 font-white"
                        ...
                        <div
                            v-if="!emptyPositions() && application != null && application.kind != 'equipment'"
                            class="mt-5 d-flex space-x-4 justify-center"
                        >
                            Загрузить общий счет на оплату: 
                            <input 
                                type="file"
                                id="commonFile"
                                class="ml-2"
                    ...
                    <div class="mt-6"></div>
                    <!-- SUBS:  -->
                    <template v-for="subapp in subs">
                        <!-- PRODUCT -->
                        <v-table                            
                            :key="subapp.id"
                            style=""
                            class="mt-12"
                            v-if="subapp != null && subapp.kind == 'product'"
                        >
                            <thead>
                                <tr>
                                    <th>№</th>
                            ...
                            <tbody>
                                <template
                                    v-for="(item, index) in subapp.application_application_products"
                                    :key="item.id"
                                >
                                    <tr>
                                        ...
                                        <td>
                                            {{ subapp.application_application_products[index].quantity?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{ subapp.application_application_products[index].prepared?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{
                                    ...
                                    <tr
                                        v-if="
                                            ...
                                            item.offers != null &&
                                            item.offers.length > 0 &&
                                            (subapp.status == 'in_progress' ||
                                            subapp.status == 'in_review')
                                        "
                                        class="bg-slate-100"
                                    >
                                        <td colspan="9" class="border-none">
                                            <v-table
                                                class="mt-4 mb-4 mx-0 border"
                                                style="overflow: visible"
                                            >
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    >
                                                        ...
                                                        <td>
                                                            <span>{{offer.quantity?.toLocaleString('ru')}}</span>
                                                        </td>
                                                        <td>
                                                            <span>{{ offer.price?.toLocaleString('ru')}} тг</span>
                                                        </td>
                                                        <td>
                                                            {{ (offer.price * offer.quantity)?.toLocaleString('ru') }} тг
                                                        </td>
                        ...
                        <v-table          
                            ...
                            style=""
                            v-if="
                                subapp != null && subapp.kind == 'service'
                            "
                        >
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <template
                                    v-for="(item, index) in subapp.application_services"
                                    :key="item.id"
                                >
                                    <tr>
                                        <td>{{ index + 1 }}</td>
                            ...
                            required density="comfortable" type="text"></v-text-field> -->
                                        ...
                                        <td>
                                            {{ subapp.application_services[index].quantity?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{ subapp.application_services[index].prepared?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{
                        ...
                        >
                            ...
                            <tbody>
                                <template
                                    v-for="(item, index) in subapp.application_equipments"
                                    :key="item.id"
                                >
                                    <tr>
                                        <td>{{ item.id }}</td>
                                        ...
                                        <td>{{ item.unit?.name }}</td>
                                        <td>
                                            {{ subapp.application_equipments[index].quantity?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{ subapp.application_equipments[index].prepared?.toLocaleString('ru') }}
                                        </td>
                                        <td>
                                            {{
                        ...
                        >
                            ...
                            >
                                <v-col cols="12">
                                    <v-btn
                                        color="primary"
                                        @click="makeApplicationEditableBySupplier(subapp.id)"
                                        class=""
                                    >
                                        Дополнить заявку
                                    </v-btn>
                            ...
                            <v-row v-if="subapp != null && subapp.status != 'draft'" no-gutters>
                                                ...
                                                >
                                                    <v-list-item-header>
                                                        <v-list-item-title>
                                                            ...
                                                            >
                                                                <strong>{{ index + 1 }}.
                                                                    {{ item.application_path.position }}</strong
                                                                >
                                                                -
                ...
                >
                    ...
                    <v-row v-if="(application != null && application.status != 'draft' && subs.length <= 0 && !isSupplier() || (signedBySupplier() && subs.length <= 0))" no-gutters>
                        <v-col no-gutters cols="12">
                            <v-expansion-panels no-gutters v-model="showPanels">
                                <v-expansion-panel value="sign">
                                    <v-expansion-panel-title>
                                    ...
                                    >
                                        <v-list-item
                                            ...
                                            v-for="(
                                                item, index
                                            ) in application.application_application_statuses"
                                            :key="item.id"
                                        >
                                            <v-list-item-header>
                                                <v-list-item-title>
        ...
        <v-dialog v-model="receiveDialog" persistent>
            <v-card>
                <v-card-title>
                    <span class="text-h5"
                        >Получение материально-товарных ценностей</span
                    >
                </v-card-title>
                        ...
                        <v-row no-gutters class="">
                            ...
                            <v-col cols="12" class="">
                                <v-table>
                                    ...
                                    <tbody>
                                        <tr
                                            v-for="(note, n) in equipmentNotes"
                                            :key="note.id"
                                        >
                                            <td>{{ n + 1 }}</td>
...
export default {
    ...
    methods: {
        signedBySupplier() {
            let signed = false;
            for (let i = 0; i < this.application.application_application_statuses.length; i++) {
                const s = this.application.application_application_statuses[i];
            
                if (this.isSupplier() && s.application_path?.responsible.id == this.currentUser.id && s.status == 'accepted') {
                    signed = true;
                }
            }
        ...
        async parentStatuses(parentId) {
            const statuses = await axios.get(`/api/v1/parent-statuses/${parentId}`);
        ...
        getSubs() {
            axios.get(`/api/v1/subapplications/${this.application.id}`).then(async (response) => {
                // console.log(response);
                this.subs = response.data;
                console.log(this.subs.length, 'subs');

                for (let i = 0; i < this.subs.length; i++) {
                    this.subs[i].signers = await this.getSigners(this.subs[i]);
                    console.log(this.subs[i].signers, 'signers');
                }
            });
        },

        signBySupplier() {
            if (!confirm('Вы уверены, что хотите подписать?')) return;
            // console.log('positions', this.positions);
            
            if (this.positions // 👈 null and undefined check
                && this.positions.length <= 0) {
                alert('Выберите хотя бы 1 позицию');
                return;
            }
            ...
            axios.post('/api/v1/check-offers', data).then((response) => {
                if (response.data === -1) {
                    this.snackbar.text = 'Ошибка: заполните предложения от компаний для выбранных позиций';
        ...
        signApplicationFirstTime() {
            ...
            try {
                axios
                    ...
                    .then((response) => {                   
                        this.snackbar.text = "Заявка успешно сохранена.";
                        this.snackbar.status = true;

                        // sign application
                        axios
                            .post( "/api/v1/sign-application-first-time/" + this.application.id)
                            .then((response) => {
                                this.getApplication();
        ...
        backToList() {
            window.location.href = `/applications?status=all&construction_id=${this.application.construction_id}`;
        },
        ...
        isOwner() {
            return (
                ...
                this.application.owner_id == this.currentUser.id
            );
        },
        ...
        isSecondCrew() {
            return (
                ...
                [
                    ...
                    "Vice President",
                    "Section Manager",
                ].includes(this.currentUser.roles[0].title)
            );
        },
        ...
        onServicePriceChanged(e) {
            ...
            axios
                .put(
                    `/api/v1/application-services/${e.target.id}/service-price`,
                    data
                )
                .then((response) => {
                    this.snackbar.text =
                        "Цена успешно обновлена. Инженер ПТО уведомлен";
                    this.snackbar.status = true;
                });
        },
        ...
        fillPositions() {
            for (let i = 0; i < this.products.length; i++) {
                // this.positions[this.products[i].id] = 0;
            }
        },
        ...
        signApplication(applicationStatus) {
            ...
            axios
                ...
                .then((response) => {
                    if (response.data === -1) {
                        this.snackbar.text =
                            "Ошибка: прикрепите счета на оплату на все позиции.";
                        this.snackbar.status = true;
        ...
        async getSigners(subapp) {
            const signers = await axios.post(`/api/v1/get-signers/${subapp.id}`);
            return signers.data;
        },
        ...
        makeApplicationEditable() {
            if (!confirm('Вы уверены, что хотите внести корректировки?')) return;
            
            axios
                .post("/api/v1/make-application-editable/" + this.application.id)
                .then((response) => {
                    this.getApplication();
        ...
        isWarehouseManager() {
            if (this.application.kind == "equipment") {
                return (
                    this.currentUser != null &&
                    this.currentUser.roles[0].title == "Section Manager"
                );
            }
        ...
        noLeftPositions() {
            let positions = 0;
            for (let i = 0; i < this.subs.length; i++) {
                positions += this.subs[i].application_application_products.length + this.subs[i].application_equipments.length + this.subs[i].application_services.length;
            }

            const appPositions = this.application.application_application_products.length + this.application.application_equipments.length + this.application.application_services.length;
            // console.log(positions, appPositions, this.application, 'positions');

            return appPositions <= 0;
        },
        ...
        addOffer(id) {
            ...
            if (this.application.kind == "product") {
                axios
                    .post("/api/v1/application-offers", data)
                    .then((response) => {
                        // console.log(response);
            ...
            if (this.application.kind == "equipment") {
                axios
                    .post("/api/v1/equipment-offers", data)
                    .then((response) => {
                        // console.log(response);
        ...
        handleOneFileUpload(event) {
            ...
            axios
                .post("/upload-one-file", formData, {
                    headers: { "Content-Type": "multipart/form-data" },
                })
                .then((response) => {
                    this.getApplication();

                    this.snackbar.text = "Общий счет на оплату закреплен";
                    this.snackbar.status = true;
                })
                .catch((error) => {
                    console.error(error);
        ...
        acceptInventory(inventoryId) {
            ...
            axios
                .put("/api/v1/inventory-applications/" + inventoryId, data)
                .then((response) => {
                    this.getApplication();
        ...
        acceptProduct() {
            if (this.application.kind == "product") {
                ...
                axios
                    ...
                    .then((response) => {
                        this.priemka.equipment.prepared =
        ...
        getWorkingDays() {
            return parseInt(
                this.equipmentNotes.reduce((acc, n) => acc + n.hours, 0) / 8
            );
        },
        ...
        sendComment() {
            ...
            axios.post("/api/v1/comments", data).then((response) => {
                this.application.comments = response.data;
            });
        },
    },
