                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            <v-btn
                                                v-if="application != null && application.status == 'draft' && isPTDEngineer()"
                                                size="small"
                                                color="error"
                                                @click="deleteProduct(item)"
                                            >
                    ...
                    >
                        ...
                        >
                            <v-col cols="12">
                                <v-btn
                                    color="primary"
                                    @click="makeApplicationEditableBySupplier()"
                                    class=""
                                >
                                    Дополнить заявку
                                </v-btn>
